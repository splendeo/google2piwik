...
#
## google2piwik v1.0, Copyright (C) 2011 by Clearcode (http://clearcode.cc)
...
class Visit(object):
    ...
    def compliance(self, other_params):
        ...
        #special_factors = ["ga:longitude", "ga:latitude", "ga:hour"]
        #for special in special_factors:
        #    compliance_factor += int(other_params.get(special) == self.google_data.get(special)) * 100
...
if __name__ == '__main__':
    ...
    parser.add_option("-u", "--update-visit", dest="update_visit_actions", default=False, action="store_true", 
                    help="updates visit total actions field (for development use only!)")
