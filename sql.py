...
INSERT_LOG_VISIT_ACTION = """INSERT INTO {{LVA}} (idvisit, idaction_url, idaction_url_ref, 
                                                  idaction_name, time_spent_ref_action)
                                          VALUES (%s, %s, %s, %s, %s) """
                                                                                                      
INSERT_LOG_ACTION =    "INSERT INTO {{LA}} (name, hash, type) VALUES (%s, %s, %s) "
INSERT_LOG_VISIT  = u""" INSERT INTO {{LV}} (idsite, visitor_localtime, visitor_idcookie, visitor_returning,
                                               visit_first_action_time, visit_last_action_time, visit_server_date,
                                    ...
                                    VALUES   ( %(idsite)s, %(visitor_localtime)s, %(visitor_idcookie)s, %(visitor_returning)s,
                                               %(visit_first_action_time)s, %(visit_last_action_time)s, %(visit_server_date)s,
                                               ...
                                               %(referer_url)s, %(referer_keyword)s, %(config_md5config)s, %(config_os)s, %(config_browser_name)s,
...
SELECT_NB_VISITS = "SELECT count(*) FROM {{LV}} WHERE visit_server_date = %s and idsite = %s"
